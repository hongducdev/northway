...
class Hub_Elementor_Custom_Controls
{
    ...
    public static function init()
    {
        ...
        add_action('elementor/element/after_section_end', function ($element, $section_id) {
            ...
            if ($element->get_name() === 'container' && 'section_layout_additional_options' === $section_id) {
                ...
                $element->start_controls_section(
                    ...
                    [
                        'label' => __('Sticky <span style="font-size: 1.5em; vertical-align:middle; margin-inline-start:0.35em;">📌<span>', 'northway'),
                ...
                $element->add_control(
                    ...
                    [
                        'label' => esc_html__('Border Animated', 'northway'),
                ...
                $element->add_control(
                    'col_fixed',
                    [
                        'label'   => esc_html__('Column Fixed', 'northway'),
                        'type'    => \Elementor\Controls_Manager::SELECT,
                        'description' => esc_html__('Only applies to the original container.', 'northway'),
                        'options' => array(
                            'none'        => esc_html__('No', 'northway'),
                            'fixed'   => esc_html__('Yes', 'northway'),
                        ),
                        'default' => 'none',
                ...
                $element->add_control(
                    'col_sticky',
                    [
                        'label'   => esc_html__('Column Sticky', 'northway'),
                        'type'    => \Elementor\Controls_Manager::SELECT,
                        'options' => array(
                            'none'           => esc_html__('No', 'northway'),
                            'sticky' => esc_html__('Yes', 'northway'),
                        ),
                        'default' => 'none',
                ...
                $element->add_control(
                    ...
                    [
                        'label' => esc_html__('Sticky Offset Top', 'northway'),
                        'type' => 'text',
                ...
                $element->add_control(
                    ...
                    [
                        'label' => esc_html__('Full Content with space from?', 'northway'),
                        'type'         => \Elementor\Controls_Manager::SELECT,
                        'prefix_class' => 'pxl-full-content-with-space-',
                        'options'      => array(
                            'none'    => esc_html__('None', 'northway'),
                            'start'   => esc_html__('Start', 'northway'),
                            'end'     => esc_html__('End', 'northway'),
                        ),
                        'default'      => 'none',
                    ]
                );
                ...
                $element->add_control(
                    'pxl_container_width',
                    [
                        'label' => esc_html__('Container Width', 'northway'),
        ...
        add_action('elementor/element/after_section_end', function ($element, $section_id) {
            ...
            if ($element->get_name() === 'container' && 'section_layout_additional_options' === $section_id) {
                ...
                $element->start_controls_section(
                    ...
                    [
                        'label' => __('Background <span style="font-size: 1.5em; vertical-align:middle; margin-inline-start:0.35em;">🖼️<span>', 'northway'),
                        'tab' => Controls_Manager::TAB_LAYOUT,
                    ]
                );
                ...
                $element->add_control(
                    'pxl_parallax_bg_img',
                    [
                        'label' => esc_html__('Parallax Background Image', 'northway'),
                ...
                $element->add_responsive_control(
                    ...
                    [
                        'label' => esc_html__('Background Position', 'northway'),
                        'type'         => \Elementor\Controls_Manager::SELECT,
                        'hide_in_inner' => true,
                        'options'      => array(
                ...
                $element->add_responsive_control(
                    ...
                    [
                        'label' => esc_html__('X Position', 'northway'),
                ...
                $element->add_responsive_control(
                    ...
                    [
                        'label' => esc_html__('Y Position', 'northway'),
                        'type' => \Elementor\Controls_Manager::SLIDER,
                        'hide_in_inner' => true,
                        'size_units' => ['px', 'em', '%', 'vw'],
                        'default' => [
                ...
                $element->add_responsive_control(
                    ...
                    [
                        'label' => esc_html__('Background Size', 'northway'),
                        'type'         => \Elementor\Controls_Manager::SELECT,
                        'hide_in_inner' => true,
                        'options'      => array(
                            ''              => esc_html__('Default', 'northway'),
                ...
                $element->add_responsive_control(
                    ...
                    [
                        'label' => esc_html__('Background Width', 'northway'),
                        'type' => \Elementor\Controls_Manager::SLIDER,
                        'hide_in_inner' => true,
                        'size_units' => ['px', 'em', '%', 'vw'],
                        'range' => [
                ...
                $element->add_control(
                    ...
                    [
                        'label' => esc_html__('Parallax Background Position', 'northway'),
                        'type' => \Elementor\Controls_Manager::POPOVER_TOGGLE,
                        'label_off' => esc_html__('Default', 'northway'),
                        'label_on' => esc_html__('Custom', 'northway'),
                        'return_value' => 'yes',
                        'condition'     => [
                            'pxl_parallax_bg_img[url]!' => ''
                        ]
                ...
                $element->add_responsive_control(
                    ...
                    [
                        'label' => esc_html__('Left', 'northway') . ' (50px) px,%,vw,auto',
                        'type' => 'text',
                        'default' => '',
                        'selectors' => [
                ...
                $element->add_responsive_control(
                    ...
                    [
                        'label' => esc_html__('Top', 'northway') . ' (50px) px,%,vw,auto',
                        'type' => 'text',
                        'default' => '',
                        'selectors' => [
                ...
                $element->add_responsive_control(
                    ...
                    [
                        'label' => esc_html__('Right', 'northway') . ' (50px) px,%,vw,auto',
                        'type' => 'text',
                        'default' => '',
                        'selectors' => [
                ...
                $element->add_responsive_control(
                    ...
                    [
                        'label' => esc_html__('Bottom', 'northway') . ' (50px) px,%,vw,auto',
                        'type' => 'text',
                        'default' => '',
                        'selectors' => [
                ...
                $element->add_control(
                    ...
                    [
                        'label' => esc_html__('Parallax Background Effect', 'northway'),
                        'type' => \Elementor\Controls_Manager::POPOVER_TOGGLE,
                        'label_off' => esc_html__('Default', 'northway'),
                        'label_on' => esc_html__('Custom', 'northway'),
                        'return_value' => 'yes',
                ...
                $element->add_control(
                    ...
                    [
                        'label' => esc_html__('TranslateX', 'northway') . ' (-80)',
                        'type' => 'text',
                        'default' => '',
                        'condition'     => [
                            'pxl_parallax_bg_img[url]!' => ''
                ...
                $element->add_control(
                    ...
                    [
                        'label' => esc_html__('TranslateY', 'northway') . ' (-80)',
                        'type' => 'text',
                        'default' => '',
                        'condition'     => [
                            'pxl_parallax_bg_img[url]!' => ''
                ...
                $element->add_control(
                    ...
                    [
                        'label' => esc_html__('TranslateZ', 'northway') . ' (-80)',
                        'type' => 'text',
                        'default' => '',
                        'condition'     => [
                            'pxl_parallax_bg_img[url]!' => ''
                ...
                $element->add_control(
                    ...
                    [
                        'label' => esc_html__('Rotate X', 'northway') . ' (30)',
                        'type' => 'text',
                        'default' => '',
                        'condition'     => [
                            'pxl_parallax_bg_img[url]!' => ''
                ...
                $element->add_control(
                    ...
                    [
                        'label' => esc_html__('Rotate Y', 'northway') . ' (30)',
                        'type' => 'text',
                        'default' => '',
                        'condition'     => [
                            'pxl_parallax_bg_img[url]!' => ''
                ...
                $element->add_control(
                    ...
                    [
                        'label' => esc_html__('Rotate Z', 'northway') . ' (30)',
                        'type' => 'text',
                        'default' => '',
                        'condition'     => [
                            'pxl_parallax_bg_img[url]!' => ''
                ...
                $element->add_control(
                    ...
                    [
                        'label' => esc_html__('Scale X', 'northway') . ' (1.2)',
                        'type' => 'text',
                        'default' => '',
                        'condition'     => [
                            'pxl_parallax_bg_img[url]!' => ''
                ...
                $element->add_control(
                    ...
                    [
                        'label' => esc_html__('Scale Y', 'northway') . ' (1.2)',
                        'type' => 'text',
                        'default' => '',
                        'condition'     => [
                            'pxl_parallax_bg_img[url]!' => ''
                ...
                $element->add_control(
                    ...
                    [
                        'label' => esc_html__('Scale Z', 'northway') . ' (1.2)',
                        'type' => 'text',
                        'default' => '',
                        'condition'     => [
                            'pxl_parallax_bg_img[url]!' => ''
                ...
                $element->add_control(
                    ...
                    [
                        'label' => esc_html__('Scale', 'northway') . ' (1.2)',
                        'type' => 'text',
                        'default' => '',
                        'condition'     => [
                            'pxl_parallax_bg_img[url]!' => ''
                ...
                $element->add_control(
                    ...
                    [
                        'label' => esc_html__('Scroll From (px)', 'northway') . ' (350) from offset top',
                        'type' => 'text',
                        'default' => '',
                        'condition'     => [
                            'pxl_parallax_bg_img[url]!' => ''
                ...
                $element->add_control(
                    ...
                    [
                        'label'         => esc_html__('Background Effect Other', 'northway'),
                        'type'          => \Elementor\Controls_Manager::SELECT,
                        'label_block'   => true,
                        'options'       => array(
                            ''        => esc_html__('None', 'northway'),
                            'pinned-zoom-clipped'    => esc_html__('Pinned Zoom Clipped', 'northway'),
                            'pinned-circle-zoom-clipped'    => esc_html__('Pinned Circle Zoom Clipped', 'northway'),
                            'mask-parallax'    => esc_html__('Mask Parallax ', 'northway'),
                            'mask-parallax light-content'    => esc_html__('Mask Parallax - Light Content', 'northway'),
                        ),
                        'default'      => '',
                ...
                $element->add_control(
                    ...
                    [
                        'label'         => esc_html__('Circle Zoom Clipped Mask Background Color', 'northway'),
                        'type'          => \Elementor\Controls_Manager::SELECT,
                        'label_block'   => true,
                ...
                $element->add_control(
                    ...
                    [
                        'label'         => esc_html__('Circle Zoom Inner Background Color', 'northway'),
                        'type'          => \Elementor\Controls_Manager::SELECT,
                        'label_block'   => true,
                        'type' => \Elementor\Controls_Manager::COLOR,
                        'selectors' => [
                ...
                $element->add_responsive_control(
                    ...
                    [
                        'label'      => esc_html__('Parallax Opacity (0 - 100)', 'northway'),
                        'type' => \Elementor\Controls_Manager::SLIDER,
                        'size_units' => ['%'],
                        'range' => [
                            '%' => [
        ...
        add_action('elementor/element/after_section_end', function ($element, $section_id) {
            ...
            if (
                ...
                $element->start_controls_section(
                    ...
                    [
                        'label' => __('Effect Images 🖊', 'northway'),
                ...
                $element->add_responsive_control(
                    ...
                    [
                        ...
                        'options'      => array(
                            ''         => esc_html__('Default', 'northway'),
                            'absolute' => esc_html__('Absolute', 'northway'),
                            'relative' => esc_html__('Relative', 'northway'),
                            'fixed'    => esc_html__('Fixed', 'northway'),
                        ),
                        'default'      => '',
                        'selectors' => [
                ...
                $element->add_control(
                    ...
                    [
                        'label' => esc_html__('Pxl Parallax Effect', 'northway'),
                        'type' => \Elementor\Controls_Manager::SELECT,
                        'options' => [
                            ''               => esc_html__('None', 'northway'),
                            'wow PXLfadeInUp' => esc_html__('PXLfadeInUp', 'northway'),
                            'wow PXLZoom2' => esc_html__('PXLZoom', 'northway'),
                            'wow PXLfadeInUp2' => esc_html__('Mouse Move Scope Class (mouse-move-scope)', 'northway'),
                        ],
                        'label_block' => true,
                        'default' => '',
                        'prefix_class' => ''
        ...
        add_action('elementor/element/after_add_attributes', 'northway_custom_el_attributes', 10, 1);
...
<?php
        ...
        function northway_custom_el_attributes(Element_Base $el)
        {
        ...
        add_action('elementor/element/after_section_end', function ($element, $section_id) {
            ...
            if (
                ...
                $element->start_controls_section(
                    ...
                    [
                        'label' => __('Northway Custom CSS 🖊', 'northway'),
                        'tab' => Controls_Manager::TAB_ADVANCED,
                    ]
                );
                ...
                $element->add_control(
                    ...
                    [
                        'raw' => sprintf(
                            esc_html__('Use "selector" to target wrapper element.%1$sselector {your css code}', 'northway'),
                            '<br><br>'
                        ),
