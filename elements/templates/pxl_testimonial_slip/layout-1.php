...
<?php if (is_array($settings['testimonial'])): ?>
    <div class="pxl-testimonial-slip pxl-testimonial-slip1">
        <div class="pxl-testimonial-slip-wrap">
            <div class="pxl-testimonial--track">
            ...
            ?>
                <div class="pxl-testimonial--block pxl-testimonial-block_<?php echo esc_attr($key+1); ?>">
