...
$wrap_attrs = [
    'id'               => $html_id,
    'class'            => trim('pxl-grid pxl-portfolio-grid pxl-portfolio-grid-layout2 pxl-portfolio-style1'),
    ...
    <?php if (!empty($next_link) && $pagination_type == 'loadmore') { ?>
        <div class="pxl-load-more">
            <span class="btn-grid-loadmore ">
                <button type="submit" class="btn pxl-button-style-2-default btn-default inline pxl-icon--right">
                    <div class="pxl-button--icon pxl-button--icon-left">
                        <i class="flaticon-arrow"></i>
                        <div class="pxl-load-icon"></div>
                    </div>
                    <span class="pxl--btn-text" data-text="Learn More Services"><?php if (!empty($settings['button_text_load_more'])) {
                        echo pxl_print_html($settings['button_text_load_more']);
                    }else {
                        echo esc_html__('Load More Projects', 'northway'); 
                    }?></span>
