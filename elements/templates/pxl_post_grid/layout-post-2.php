...
if($settings['col_xl'] == '5') {
    ...
    $col_xl = 12 / intval($widget->get_setting('col_xl', 12));
}
$col_lg = 12 / intval($widget->get_setting('col_lg', 12));
$col_md = 12 / intval($widget->get_setting('col_md', 12));
$col_sm = 12 / intval($widget->get_setting('col_sm', 12));
$col_xs = 12 / intval($widget->get_setting('col_xs', 12));
...
$wrap_attrs = [
    'id'               => $html_id,
    'class'            => trim('pxl-grid pxl-blog-grid pxl-blog-grid-layout2 pxl-blog-style1'),
