<div class="pxl-icon-box pxl-icon-box12 <?php echo esc_attr($settings['animate_hover'].' '.$settings['pxl_animate']); ?> <?php echo esc_attr($settings['item_divider_12'] == 'true' ? 'pxl-border-right' : ''); ?>" data-wow-delay="<?php echo esc_attr($settings['pxl_animate_delay']); ?>ms">
