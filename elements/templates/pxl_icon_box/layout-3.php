<div class="pxl-icon-box pxl-icon-box3 <?php echo esc_attr($settings['style_3'].' '.$settings['animate_hover'].' '.$settings['pxl_animate']); ?> <?php echo esc_attr($settings['item_divider_3'] == 'true' ? 'pxl-border-right' : ''); ?>" data-wow-delay="<?php echo esc_attr($settings['pxl_animate_delay']); ?>ms">
