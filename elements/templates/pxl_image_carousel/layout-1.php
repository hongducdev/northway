                        ...
                        <div class="pxl-swiper-slide">
                            <div class="pxl-item--inner">
                                <?php if(!empty($image['id'])) { 
                                    ...
                                    $thumbnail_url_2 = $img_2['url'];
                                    ?>
                                    <?php if ($settings['style_img'] == 'image') { ?>
                                        <div class="pxl-item--image ">
                                            <div class="pxl-item--image-1">
                                                <label class="pxl-item--image-label"><?php echo esc_html__('Before', 'northway'); ?></label>
                                                <div class="pxl-item--image-1-inner">
                                                    <?php echo wp_kses_post($thumbnail); ?>
                                                </div>
                                            </div>
                                            <div class="pxl-item--image-2">
                                                <label class="pxl-item--image-label"><?php echo esc_html__('After', 'northway'); ?></label>
                                                <div class="pxl-item--image-2-inner">
