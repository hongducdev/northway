 <?php
    ...
    $direction_setting = isset($settings['direction']) ? $settings['direction'] : 'default';
    $direction = ($direction_setting === 'ltr' || $direction_setting === 'rtl') ? $direction_setting : (is_rtl() ? 'rtl' : 'ltr');
    $opts = [
