                                ...
                                <?php if (!empty($image['id'])) {
                                    ...
                                    <div class="pxl-item--image ">
                                        ...
                                        <?php if (!empty($url_video)) { ?>
                                            <a class="pxl-btn-video pxl-action-popup el-parallax-item" href="<?php echo esc_url($url_video); ?>">
