...
<div class="pxl-counter pxl-counter4 <?php echo esc_attr($settings['pxl_animate'].' '.($settings['style'])); ?>" data-wow-delay="<?php echo esc_attr($settings['pxl_animate_delay']); ?>ms">
