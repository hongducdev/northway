...
<div class="pxl-counter pxl-counter3 <?php echo esc_attr($settings['pxl_animate'].' '.($settings['style'])); ?>" data-wow-delay="<?php echo esc_attr($settings['pxl_animate_delay']); ?>ms">
    <div class="pxl-counter--inner">
        <div class="pxl-counter--wrapper">
        <div class="pxl-counter--front ">
