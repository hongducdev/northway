<?php
	...
	extract($settings); 
	$month = esc_html__('Month', 'northway');
	$months = esc_html__('Months', 'northway');
	$day = esc_html__('Day', 'northway');
	$days = esc_html__('Days', 'northway');
	$hour = esc_html__('Hour', 'northway');
	$hours = esc_html__('Hours', 'northway');
	$minute = esc_html__('Minute', 'northway');
	$minutes = esc_html__('Minutes', 'northway');
	$second = esc_html__('Second', 'northway');
	$seconds = esc_html__('Seconds', 'northway');
	if($style == 'style2') {
		$hour = esc_html__('Hour', 'northway');
		$hours = esc_html__('Hour', 'northway');
		$minute = esc_html__('Min', 'northway');
		$minutes = esc_html__('Min', 'northway');
		$second = esc_html__('Sec', 'northway');
		$seconds = esc_html__('Sec', 'northway');
	}
?>
