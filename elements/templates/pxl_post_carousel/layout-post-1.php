                                    ...
                                    <div class="pxl-post--featured hover-imge-effect2">
                                        ...
                                        <?php if ($show_date == 'true'): ?>
                                            <div class="pxl-post--date">
                                                ...
                                                <span class="pxl-post--date-month"><?php echo get_the_date('M', $post->ID) ?></span>
                                            </div>
                                        <?php endif; ?>
                                        ...
                                        <div class="pxl-post--holder">
                                            <h5 class="pxl-post--holder-title ">
                                                <a href="<?php echo esc_url(get_permalink($post->ID)); ?>">
                                                    <?php echo pxl_print_html(get_the_title($post->ID)); ?>
                                                </a>
                                            </h5>
                                            <div class="pxl-post--holder-content">
                                                    ...
                                                    <?php if ($show_date == 'true' || $show_author == 'true'): ?>
                                                        <?php if ($show_author == 'true'): ?>
                                                            <div class="pxl-post--meta-item">
                                                                ...
                                                                <span class="pxl-post--meta-item-author">
