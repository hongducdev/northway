<?php if(!empty($settings['percentage_value'])) : 
    $main_color = northway()->get_opt('primary_color', '#2723E0');
    ?>
    <div class="pxl-pie-chart pxl-pie-chart2 <?php echo esc_attr($settings['pxl_animate']); ?>" data-wow-delay="<?php echo esc_attr($settings['pxl_animate_delay']); ?>ms">
