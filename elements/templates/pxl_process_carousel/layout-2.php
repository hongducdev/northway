<?php
if (!isset($settings['lists_2']) || !is_array($settings['lists_2']) || empty($settings['lists_2'])) {
    return;
}
...
$items_count = count($settings['lists_2']);
?>

<div class="pxl-swiper-slider pxl-process-carousel pxl-process-carousel2" <?php if($drap !== false) : ?>data-cursor-drap="<?php echo esc_attr('DRAG'); ?>"<?php endif; ?>>
    <div class="pxl-carousel-inner">
        <div <?php pxl_print_html($widget->get_render_attribute_string( 'carousel' )); ?>>
            <div class="pxl-swiper-wrapper">
                <?php foreach ($settings['lists_2'] as $key => $value):
                    $title = isset($value['title_2']) ? $value['title_2'] : '';
                    $year = isset($value['year_2']) ? $value['year_2'] : '';
