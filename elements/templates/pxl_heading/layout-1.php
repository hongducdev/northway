	...
	<div class="pxl-heading--inner">
		<?php if(!empty($settings['sub_title'])) : ?>
			<div class="pxl-item--subtitle <?php echo esc_attr($settings['sub_title_style'].' '.$settings['pxl_animate_sub']); ?>" data-wow-delay="<?php echo esc_attr($settings['pxl_animate_delay_sub']); ?>ms">
				<?php if($settings['sub_title_style'] == 'pxl-sub-title-default' || $settings['sub_title_style'] == 'pxl-sub-title-2') : ?>
					<div class="pxl-item--subtitle-icon wow zoomIn">
						<svg xmlns="http://www.w3.org/2000/svg" width="10" height="11" viewBox="0 0 10 11" fill="none">
							<path d="M5.35355 0.853553C5.15829 0.658291 4.84171 0.658291 4.64645 0.853553L0.353553 5.14645C0.158291 5.34171 0.158291 5.65829 0.353554 5.85355L4.64645 10.1464C4.84171 10.3417 5.15829 10.3417 5.35355 10.1464L9.64645 5.85355C9.84171 5.65829 9.84171 5.34171 9.64645 5.14645L5.35355 0.853553Z" fill="currentColor"/>
						</svg>
					</div>
				<?php endif; ?>
				...
				<?php if($settings['sub_title_style'] == 'pxl-sub-title-2') : ?>
					<div class="pxl-item--subtitle-icon wow zoomIn">
						<svg xmlns="http://www.w3.org/2000/svg" width="10" height="11" viewBox="0 0 10 11" fill="none">
							<path d="M5.35355 0.853553C5.15829 0.658291 4.84171 0.658291 4.64645 0.853553L0.353553 5.14645C0.158291 5.34171 0.158291 5.65829 0.353554 5.85355L4.64645 10.1464C4.84171 10.3417 5.15829 10.3417 5.35355 10.1464L9.64645 5.85355C9.84171 5.65829 9.84171 5.34171 9.64645 5.14645L5.35355 0.853553Z" fill="currentColor"/>
						</svg>
