(function ($) {
            ...
            slides.each(function () {
                if ($(this).hasClass("swiper-slide-visible")) {
                    var thisSlideOffsetLeft = $(this).offset().left - 1,
                        thisSlideOffsetRight =
                            $(this).offset().left + 1 + $(this).outerWidth();

                    if (
                        thisSlideOffsetLeft > elOffsetLeft &&
                        thisSlideOffsetRight < elOffsetRight
                    ) {
                        $(this)
                            .addClass("swiper-slide-active")
                            .removeClass("swiper-slide-uncentered");
                    } else {
                        $(this)
                            .removeClass("swiper-slide-active")
                            .addClass("swiper-slide-uncentered");
                    }
                }
            });
        }
                ...
                $(this)
                    ...
                    .each(function () {
                        ...
                        if (windowWidth <= 1199) {
                            ...
                            $(this)
                                .find(
                                    ".pxl-post--inner .pxl-post--featured img"
                                )
                                .each(function () {
                                    slideHeight += $(this).outerHeight() || 0;
                                });
    ...
    $(window).on("elementor/frontend/init", function () {
        ...
        elementorFrontend.hooks.addAction(
            "frontend/element_ready/pxl_client_carousel.default",
            function ($scope) {
                pxl_swiper_handler($scope);
            }
        );
        ...
        elementorFrontend.hooks.addAction(
            "frontend/element_ready/pxl_testimonial_slip.default",
            function ($scope) {
                pxl_swiper_handler($scope);
            }
        );
        ...
        elementorFrontend.hooks.addAction(
            "frontend/element_ready/pxl_iconbox_carousel.default",
            function ($scope) {
                pxl_swiper_handler($scope);
            }
        );
        ...
        elementorFrontend.hooks.addAction(
            "frontend/element_ready/pxl_process_carousel.default",
            function ($scope) {
                pxl_swiper_handler($scope);
            }
        );
