(function ($) {
    ...
    function northway_animation_handler($scope) {
        ...
        elementorFrontend.waypoint(
            $scope.find(".PXLfadeInUp,.PXLZoom2"),
            function () {
                $(this).addClass("pxl-animated");
            }
        );
    ...
    function northway_section_start_render() {
        var _elementor =
    ...
    function northway_css_inline_js() {
    ...
    function northway_section_before_render() {
        var _elementor =
            typeof elementor != "undefined" ? elementor : elementorFrontend;
        _elementor.hooks.addFilter(
    ...
    function northway_split_text($scope) {
    ...
    function northway_scroll_trigger($scope) {
    ...
    function northway_logo_marquee($scope) {
    ...
    function northway_scroll_checkp($scope) {
    ...
    function northway_section_start_render2() {
        var _elementor =
            typeof elementor != "undefined" ? elementor : elementorFrontend;
    ...
    function pxl_widget_sphere_handler($scope) {
        ...
        const sphereColor =
            sphereEl.data("color") || "rgba(255, 255, 255, 0.15)";
    ...
    function northway_parallax_bg() {
        ...
        $(document)
            .find(".pxl-bg-prx-effect-pinned-zoom-clipped")
            .each(function (index, el) {
                ...
                window.addEventListener(
                    "resize",
                    set_clipped_bg_wrapper_height
                );
            });

        $(document)
            .find(".pxl-bg-prx-effect-pinned-circle-zoom-clipped")
            .each(function (index, el) {
                const $el = $(el);
                ...
                window.addEventListener("load", northway_circle_init);
                window.addEventListener("resize", northway_circle_resize);
                function northway_circle_init() {
                    northway_circle_resize();
                }
                function northway_circle_resize() {
                    tl.progress(0);
    ...
    $(window).on("elementor/frontend/init", function () {
        elementorFrontend.hooks.addAction(
            ...
            function ($scope) {
                northway_scroll_checkp($scope);
                northway_animation_handler($scope);
            }
        );
        northway_section_start_render();
        northway_section_start_render2();
        northway_parallax_bg();
        northway_css_inline_js();
        northway_section_before_render();
        northway_zoom_point();
        northway_scroll_fixed_section();
        elementorFrontend.hooks.addAction(
        ...
        elementorFrontend.hooks.addAction(
            "frontend/element_ready/pxl_section_scale.default",
            function ($scope) {
                northway_scroll_trigger($scope);
            }
        );
        elementorFrontend.hooks.addAction(
            "frontend/element_ready/pxl_logo_marquee.default",
            function ($scope) {
                northway_logo_marquee($scope);
            }
        );
        elementorFrontend.hooks.addAction(
            "frontend/element_ready/pxl_text_marquee.default",
            function ($scope) {
                northway_text_marquee($scope);
            }
        );
    });
})(jQuery);
