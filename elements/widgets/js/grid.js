    ...
    $(window).on("elementor/frontend/init", function () {
        setTimeout(function () {
            $(".pxl-grid").each(function (index, element) {
                var $grid_scope = $(this);
                var $grid_masonry = $grid_scope.find(
                    ".pxl-grid-masonry, .pxl-grid-masonry-adm"
                );
                var layoutMode = $grid_masonry.data("layout") || "masonry";
                var isoOptions = {
                ...
                $grid_scope.on(
                    ...
                    function (e) {
                        ...
                        if (
                            ...
                            northway_grid_ajax_handler(
                                $this,
                                $grid_scope,
                                $grid_isotope,
                                {
                                    action: "northway_load_more_post_grid",
                                    loadmore: loadmore,
        ...
        function northway_grid_ajax_handler(
            $this,
            $grid_scope,
            $grid_isotope,
            args = {}
