...
pxl_add_custom_widget(
    array(
        'name' => 'pxl_image',
        'title' => esc_html__('Case Image', 'northway' ),
        'icon' => 'eicon-image',
            ...
            'sections' => array(
                array(
                    ...
                    'controls' => array(
                        ...
                        array(
                            'name' => 'image',
                            'label' => esc_html__('Choose Image', 'northway' ),
                ...
                array(
                    ...
                    'controls' => array(
                        ...
                        array(
                            'name' => 'img_effect',
                            'label' => esc_html__('Image Effect', 'northway' ),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'options' => [
                                '' => 'None',
                        ...
                        array(
                            ...
                            'label' => esc_html__('Parallax Value', 'northway' ),
                            'type' => \Elementor\Controls_Manager::TEXT,
                            'condition' => [
                                'img_effect' => 'pxl-parallax-scroll',
                            ],
                        ...
                        array(
                            'name' => 'max_tilt',
                            'label' => esc_html__('Max Tilt', 'northway' ),
                            'type' => \Elementor\Controls_Manager::TEXT,
                            'condition' => [
                        ...
                        array(
                            'name' => 'speed_tilt',
                            'label' => esc_html__('Speed Tilt', 'northway' ),
                            'type' => \Elementor\Controls_Manager::TEXT,
                            'condition' => [
                                'img_effect' => 'pxl-image-tilt',
                            ],
                        ...
                        array(
                            ...
                            'label' => esc_html__('Perspective Tilt', 'northway' ),
                            'type' => \Elementor\Controls_Manager::TEXT,
                            'condition' => [
                                'img_effect' => 'pxl-image-tilt',
                            ],
