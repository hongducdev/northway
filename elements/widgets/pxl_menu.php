...
pxl_add_custom_widget(
    array(
        'name' => 'pxl_menu',
        'title' => esc_html__('Case Nav Menu', 'northway'),
        'icon' => 'eicon-nav-menu',
            ...
            'sections' => array(
                array(
                    ...
                    'controls' => array(
                        array(
                            'name' => 'menu',
                            'label' => esc_html__('Select Menu', 'northway'),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'options' => $pxl_menus,
                        ),
                        array(
                            'name' => 'menu_type',
                            'label' => esc_html__('Menu Type', 'northway'),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'options' => [
                        ...
                        array(
                            'name' => 'menu_stype',
                            'label' => esc_html__('Menu Style', 'northway'),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'options' => [
                                'df' => 'Default',
                            ],
                        ...
                        array(
                            'name' => 'text_align',
                            'label' => esc_html__('Text Alignment', 'northway'),
                            'type' => \Elementor\Controls_Manager::CHOOSE,
                            'options' => [
                                'left' => [
                                    'title' => esc_html__('Left', 'northway'),
                ...
                array(
                    ...
                    'label' => esc_html__('First Level', 'northway'),
                    ...
                    'controls' => array(
                        ...
                        array(
                            'name' => 'arrow_color',
                            'label' => esc_html__('Arrow Color', 'northway'),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                        ...
                        array(
                            ...
                            'label' => esc_html__('Arrow Has Children - Font Size', 'northway'),
                            'type' => \Elementor\Controls_Manager::SLIDER,
                            'size_units' => ['px'],
                            'range' => [
                                'px' => [
                        ...
                        array(
                            'name' => 'item_space1',
                            'label' => esc_html__('Extra Space Bottom', 'northway'),
                            'type' => \Elementor\Controls_Manager::SLIDER,
                            'control_type' => 'responsive',
                            'size_units' => ['px'],
                            'range' => [
                        ...
                        array(
                            'name' => 'flex_grow',
                            'label' => esc_html__('Flex Grow', 'northway'),
                            'type' => \Elementor\Controls_Manager::CHOOSE,
                            'options' => [
                                'inherit' => [
                                    'title' => esc_html__('Inherit', 'northway'),
                        ...
                        array(
                            'name' => 'menu_mega_type',
                            'label' => esc_html__('Menu Mega Type', 'northway'),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'options' => [
                        ...
                        array(
                            ...
                            'label' => esc_html__('Mega Menu Spacer Left', 'northway'),
                            'type' => \Elementor\Controls_Manager::SLIDER,
                            'size_units' => ['px'],
                            'range' => [
                                'px' => [
                        ...
                        array(
                            ...
                            'label' => esc_html__('Mega Menu Spacer Right', 'northway'),
                            'type' => \Elementor\Controls_Manager::SLIDER,
                            'size_units' => ['px'],
                            'range' => [
                                'px' => [
                        ...
                        array(
                            ...
                            'label' => esc_html__('Mega Menu Container Max Width', 'northway'),
                            'type' => \Elementor\Controls_Manager::SLIDER,
                            'size_units' => ['px'],
                            'range' => [
                                'px' => [
                ...
                array(
                    ...
                    'label' => esc_html__('Sub Level', 'northway'),
                    'tab' => \Elementor\Controls_Manager::TAB_STYLE,
                    'controls' => array(
                        array(
                            'name' => 'sub_color',
                        ...
                        array(
                            ...
                            'label' => esc_html__('Color Hover/Actvie', 'northway'),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                        ...
                        array(
                            'name' => 'sub_bg_color',
                            'label' => esc_html__('Box Background Color', 'northway'),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                        ...
                        array(
                            ...
                            'label' => esc_html__('Hover/Active Style', 'northway'),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'options' => [
                        ...
                        array(
                            ...
                            'label' => esc_html__('Show Effect', 'northway'),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'options' => [
                        ...
                        array(
                            ...
                            'label' => esc_html__('Box Spacer Top', 'northway'),
                            'type' => \Elementor\Controls_Manager::SLIDER,
                            'size_units' => ['px'],
                            'range' => [
                                'px' => [
                        ...
                        array(
                            ...
                            'label' => esc_html__('Box Spacer Top - Mega', 'northway'),
                            'type' => \Elementor\Controls_Manager::SLIDER,
                            'size_units' => ['px'],
                            'range' => [
                                'px' => [
