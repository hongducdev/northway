...
pxl_add_custom_widget(
    array(
        ...
        'title' => esc_html__('Case Video Button', 'northway' ),
        'icon' => 'eicon-play',
            ...
            'sections' => array(
                array(
                    ...
                    'controls' => array(
                        ...
                        array(
                            'name' => 'video_icon',
                            'label' => esc_html__('Video Icon', 'northway' ),
                        ...
                        array(
                            ...
                            'type' => \Elementor\Controls_Manager::TEXT,
                            'default' => esc_html__('Label', 'northway'),
                        ), 
                        array(
                            'name' => 'image_type',
                            'label' => esc_html__('Image Type', 'northway' ),
                            ...
                            'default' => 'none',
                            'condition' => [
                                'btn_video_style' => ['style1', 'style-blur', 'style-outline-2', 'style-icon'],
                            ],
                        ),
                        array(
                            'name' => 'image',
                        ...
                        array(
                            ...
                            'label' => esc_html__('Image Border Radius', 'northway' ),
                        ...
                        array(
                            'name' => 'box_style',
                            'label' => esc_html__('Background Effect', 'northway' ),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'options' => [
                                'parallax' => 'Parallax',
                                'default' => 'No Parallax',
                        ...
                        array(
                            ...
                            'label' => esc_html__('Button Video Style', 'northway' ),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'options' => [
                                'style1' => 'Style White',
                        ...
                        array(
                            ...
                            'label' => esc_html__('Button Video Position', 'northway' ),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'options' => [
                                'p-center' => 'Center',
                                'p-top-left' => 'Top Left',
                        ...
                        array(
                            'name' => 'top_positioon',
                            'label' => esc_html__('Top Position', 'northway' ),
                            'type' => \Elementor\Controls_Manager::SLIDER,
                            'size_units' => [ 'px', '%' ],
                            'control_type' => 'responsive',
                            'default' => [
                        ...
                        array(
                            ...
                            'label' => esc_html__('Right Position', 'northway' ),
                            'type' => \Elementor\Controls_Manager::SLIDER,
                            'size_units' => [ 'px', '%' ],
                            'control_type' => 'responsive',
                            'default' => [
                        ...
                        array(
                            ...
                            'label' => esc_html__('Bottom Position', 'northway' ),
                            'type' => \Elementor\Controls_Manager::SLIDER,
                            'size_units' => [ 'px', '%' ],
                            'control_type' => 'responsive',
                            'default' => [
                        ...
                        array(
                            'name' => 'left_positioon',
                            'label' => esc_html__('Left Position', 'northway' ),
                            'type' => \Elementor\Controls_Manager::SLIDER,
                            'size_units' => [ 'px', '%' ],
                            'control_type' => 'responsive',
                            'default' => [
                ...
                array(
                    ...
                    'controls' => array(
                        ...
                        array(
                            'name' => 'bgcolor_hv',
                            'label' => esc_html__('Background Icon Hover Color', 'northway' ),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
