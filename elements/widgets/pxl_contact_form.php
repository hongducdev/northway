...
if (class_exists('WPCF7')) {
    ...
    if ($cf7) {
        ...
        $contact_forms[esc_html__('No contact forms found', 'northway')] = 0;
    }

    pxl_add_custom_widget(
        array(
            'name' => 'pxl_contact_form',
            'title' => esc_html__('Case Contact Form', 'northway'),
                ...
                'sections' => array(
                    array(
                        ...
                        'controls' => array(
                            array(
                                'name' => 'form_id',
                                'label' => esc_html__('Select Form', 'northway'),
                    ...
                    array(
                        ...
                        'label' => esc_html__('Input', 'northway'),
                        ...
                        'controls' => array(
                            ...
                            array(
                                ...
                                'label' => esc_html__('Border Color Focus', 'northway'),
                                'type' => \Elementor\Controls_Manager::COLOR,
                                'default' => '',
                                'selectors' => [
                            ...
                            array(
                                'name' => 'input_height',
                                'label' => esc_html__('Input Height', 'northway'),
                            ...
                            array(
                                ...
                                'label' => esc_html__('Textarea Height', 'northway'),
                                'type' => \Elementor\Controls_Manager::SLIDER,
                                'control_type' => 'responsive',
                                'size_units' => ['px'],
                                'range' => [
                            ...
                            array(
                                ...
                                'label' => esc_html__('Padding Textarea', 'northway'),
                                'type' => \Elementor\Controls_Manager::DIMENSIONS,
                                'size_units' => ['px'],
                                'selectors' => [
                            ...
                            array(
                                ...
                                'label' => esc_html__('Textarea Border Type', 'northway'),
                                'type' => \Elementor\Controls_Manager::SELECT,
                                'options' => [
                                    '' => esc_html__('None', 'northway'),
                                    'solid' => esc_html__('Solid', 'northway'),
                            ...
                            array(
                                ...
                                'label' => esc_html__('Textarea Border Width', 'northway'),
                                'type' => \Elementor\Controls_Manager::DIMENSIONS,
                                'selectors' => [
                            ...
                            array(
                                ...
                                'label' => esc_html__('Textarea Typography', 'northway'),
                                'type' => \Elementor\Group_Control_Typography::get_type(),
                                'control_type' => 'group',
                            ...
                            array(
                                'name' => 'textarea_color',
                                'label' => esc_html__('Textarea Color', 'northway'),
                                'type' => \Elementor\Controls_Manager::COLOR,
                                'selectors' => [
                            ...
                            array(
                                ...
                                'label' => esc_html__('Spacer Bottom', 'northway'),
                                'type' => \Elementor\Controls_Manager::SLIDER,
                                'control_type' => 'responsive',
                                'size_units' => ['px'],
                                'range' => [
                            ...
                            array(
                                ...
                                'label' => esc_html__('Spacer Left', 'northway'),
                                'type' => \Elementor\Controls_Manager::SLIDER,
                                'control_type' => 'responsive',
                                'size_units' => ['px'],
                                'range' => [
                            ...
                            array(
                                ...
                                'label' => esc_html__('Spacer right', 'northway'),
                                'type' => \Elementor\Controls_Manager::SLIDER,
                                'control_type' => 'responsive',
                                'size_units' => ['px'],
                                'range' => [
                    ...
                    array(
                        ...
                        'label' => esc_html__('Input Hover', 'northway'),
                        'tab' => \Elementor\Controls_Manager::TAB_STYLE,
                        'controls' => array(
                            array(
                        ...
                        'controls' => array_merge(
                            array(
                                ...
                                array(
                                    ...
                                    'label' => esc_html__('Button Color Hover', 'northway'),
                                    'type' => \Elementor\Controls_Manager::COLOR,
                                    'selectors' => [
                                ...
                                array(
                                    ...
                                    'label' => esc_html__('Button Background Color', 'northway'),
                                    'type' => \Elementor\Controls_Manager::COLOR,
                                    'selectors' => [
                                ...
                                array(
                                    ...
                                    'label' => esc_html__('Button Background Color Hover', 'northway'),
                                    'type' => \Elementor\Controls_Manager::COLOR,
                                    'selectors' => [
                                        '{{WRAPPER}} .pxl-contact-form .wpcf7-submit:hover, {{WRAPPER}} .pxl-contact-form .wpcf7-submit:focus, {{WRAPPER}} .pxl-contact-form button:hover, {{WRAPPER}} .pxl-contact-form button:focus' => 'background-color: {{VALUE}} !important;',
                                    ],
                                ),
                            ),
                            northway_widget_gradient_color([
                                'prefix' => 'gr',
                                'label' => 'Button',
                            ...
                            array(
                                array(
                                    ...
                                    'size_units' => ['px'],
                                    'selectors' => [
                                        '{{WRAPPER}} .pxl-contact-form .wpcf7-submit, {{WRAPPER}} .pxl-contact-form button' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important;',
                                    ],
                                    'control_type' => 'responsive',
                                ),
                                array(
                                ...
                                array(
                                    'name' => 'btn_spacer_top',
                                    'label' => esc_html__('Spacer Top', 'northway'),
                                    'type' => \Elementor\Controls_Manager::SLIDER,
                                    'control_type' => 'responsive',
                                    'size_units' => ['px'],
                                    'range' => [
                    ...
                    array(
                        'name' => 'extra',
                        'label' => esc_html__('Extra', 'northway'),
                        'tab' => \Elementor\Controls_Manager::TAB_STYLE,
                        'controls' => array(
                            array(
                            ...
                            array(
                                'name' => 'des_box_color',
                                'label' => esc_html__('Description Box Color', 'northway'),
                                'type' => \Elementor\Controls_Manager::COLOR,
                                'selectors' => [
                            ...
                            array(
                                'name' => 'ntt_padding',
                                'label' => esc_html__('Notice Margin', 'northway'),
                                'type' => \Elementor\Controls_Manager::DIMENSIONS,
                                'size_units' => ['px'],
                                'selectors' => [
                            ...
                            array(
                                ...
                                'label' => esc_html__('Notification Color', 'northway'),
                                'type' => \Elementor\Controls_Manager::COLOR,
                                'selectors' => [
                            ...
                            array(
                                ...
                                'label' => esc_html__('Label Spacer Bottom', 'northway'),
                                'type' => \Elementor\Controls_Manager::SLIDER,
                                'control_type' => 'responsive',
                                'size_units' => ['px'],
                                'range' => [
