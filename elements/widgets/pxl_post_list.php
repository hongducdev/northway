...
pxl_add_custom_widget(
    array(
        'name' => 'pxl_post_list',
        'title' => esc_html__('Case Post List', 'northway'),
            ...
            'sections' => array(
                array(
                    ...
                    'controls' => array_merge(
                        ...
                        northway_get_post_list_layout($pt_supports)
                    ),
                ),
                ...
                array(
                    ...
                    'controls' => array(
                        array(
                            'name' => 'tab_effect',
                            'label' => esc_html__('Tab Effect', 'northway'),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'default' => 'tab-effect-fade',
                            'options' => [
                                '' => esc_html__('None', 'northway'),
                                'tab-effect-fade' => esc_html__('Fade', 'northway'),
                                'tab-effect-slide' => esc_html__('Slide', 'northway'),
                            ],
                            'conditions' => [
                                'relation' => 'or',
                                'terms' => [
                        ...
                        array(
                            'name' => 'tab_duration',
                            'label' => esc_html__('Animation Duration (ms)', 'northway'),
                            'type' => \Elementor\Controls_Manager::NUMBER,
                            'default' => 400,
                            'min' => 100,
                            'max' => 2000,
                                ...
                                'terms' => [
                                    [
                                        'terms' => [
                                            ['name' => 'post_type', 'operator' => '==', 'value' => 'portfolio'],
                                            ['name' => 'layout_portfolio', 'operator' => 'in', 'value' => ['portfolio-1']],
                                            ['name' => 'tab_effect', 'operator' => '!=', 'value' => '']
                                        ]
                                    ]
                                ],
                            ],
