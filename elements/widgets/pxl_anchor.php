...
$templates_lv1 = ['1' => esc_html__('Hidden Panel Mobile', 'northway')];
$templates = $templates_df + $templates_lv1 + northway_get_templates_option('hidden-panel') ;
pxl_add_custom_widget(
    array(
        'name' => 'pxl_anchor',
        'title' => esc_html__('Case Anchor', 'northway' ),
        'icon' => 'eicon-anchor',
            ...
            'sections' => array(
                array(
                    ...
                    'controls' => array(
                        ...
                        array(
                            'name' => 'pxl_icon',
                            'label' => esc_html__('Select Icon', 'northway' ),
                        ...
                        array(
                            ...
                            'label' => esc_html__('Close Popup - Animation Delay', 'northway' ),
                ...
                array(
                    ...
                    'controls' => array(
                        ...
                        array(
                            ...
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} .pxl-anchor-button::before' => 'background-color: {{VALUE}}',
                            ],
                        ),
                    ),
                ),
