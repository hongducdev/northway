...
pxl_add_custom_widget(
    array(
        ...
        'title' => esc_html__('Case Progress Bar', 'northway'),
        'icon' => 'eicon-skill-bar',
        'categories' => array('pxltheme-core'),
        'scripts' => array(
            'pxl-progressbar',
            'northway-progressbar',
        ),
        'params' => array(
            'sections' => array(
                array(
                ...
                array(
                    ...
                    'controls' => array(
                        array(
                            'name' => 'progressbar',
                            'label' => esc_html__('Progress Bar', 'northway'),
                ...
                array(
                    ...
                    'controls' => array(
                        array(
                            ...
                            'label' => esc_html__('Percentage Color', 'northway'),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                        ...
                        array(
                            ...
                            'label' => esc_html__('Percentage Typography', 'northway'),
                            'type' => \Elementor\Group_Control_Typography::get_type(),
                            'control_type' => 'group',
                ...
                array(
                    'name' => 'tab_style_bar',
                    'label' => esc_html__('Bar', 'northway'),
                    'tab' => \Elementor\Controls_Manager::TAB_STYLE,
                    'controls' => array(
                        array(
                            'name' => 'bar_color',
                            'label' => esc_html__('Bar Color', 'northway'),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                        ...
                        array(
                            'name' => 'bar_bg_color',
                            'label' => esc_html__('Bar Background Color', 'northway'),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
