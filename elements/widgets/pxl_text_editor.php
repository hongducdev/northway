...
pxl_add_custom_widget(
    array(
        ...
        'title' => esc_html__('Case Text Editor', 'northway'),
        'icon' => 'eicon-text',
        ...
        'params' => array(
            'sections' => array(
                array(
                    ...
                    'label' => esc_html__('Text Editor', 'northway' ),
                ...
                array(
                    ...
                    'label' => esc_html__( 'Block Quote', 'northway' ),
                    'tab' => Controls_Manager::TAB_STYLE,
                    'controls' => array(
                        array(
                            'name' => 'textb_color',
                ...
                array(
                    ...
                    'controls' => array(
                        array(
                            'name' => 'style_hv',
                            'label' => esc_html__('Style Hover', 'northway' ),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'default' => 'default',
                            'options' => [
                                'default' => esc_html__('Default', 'northway' ),
                                'underline' => esc_html__('Underline', 'northway' ),
                            ],
                        ),
                        array(
                            'name' => 'link_color',
