                ...
                <div class="<?php echo esc_attr($item_class . ' ' . $filter_class); ?>">
                    <div class="pxl-post--inner <?php echo esc_attr($pxl_animate); ?>" data-wow-duration="1.2s">
                        ...
                        <div class="pxl-post--readmore">
                            ...
                            <?php endif; ?>
                            <?php if ($show_button == 'true'): ?>
                                <a class="pxl-post--readmore-button" href="<?php echo esc_url(get_permalink($post->ID)); ?>">
                                    <span><?php echo esc_html__('Read More', 'northway'); ?></span>
                                    <i class="bi-arrow-right-short"></i>
                                </a>
                            <?php endif; ?>
                        </div>
