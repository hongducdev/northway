...
if (!class_exists('Northway_Main')) {
    class Northway_Main extends Northway_Base
    {
        ...
        public static function getInstance()
        {
            ...
            if (null === self::$instance) {
                self::$instance = new Northway_Main();
            }
...
function northway()
{
    return Northway_Main::getInstance();
}
// Install
northway();
