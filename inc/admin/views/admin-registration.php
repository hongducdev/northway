...
$license = trim(get_option(northway()->get_slug() . '_purchase_code'));

$active = get_option(northway()->get_slug() . '_purchase_code_status', false) === 'valid';
if ($dev_mode === true) $active = true;

$register = new Northway_Register;

$pxl_server_info = apply_filters('pxl_server_info', ['docs_url' => 'https://doc.casethemes.net/', 'support_url' => 'https://bravisthemes.ticksy.com/']);
?>
<?php if ($active): ?>
