<?php
/**
* The Northway_Admin initiate the theme admin
*/
...
class Northway_Admin extends Northway_Base{
    ...
    public function fix_parent_menu() {
		...
		$submenu['pxlart'][0][0] = northway()->get_name().' '.esc_html__( 'Dashboard', 'northway' );
