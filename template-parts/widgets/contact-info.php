...
class PXL_Contact_Info_Widget extends WP_Widget
{
    ...
    function __construct()
    {
        parent::__construct(
            ...
            esc_html__('Northway Contact Info', 'northway'),
            array('description' => esc_html__('Show Author Information', 'northway'),)
        );
    }
...
?>
        <div class="pxl-contact-info-widget bg-image" style="background-image: url(<?php echo esc_url($bg_box_url) ?>); ?>);">
            <div class="content-inner">
                ...
                <?php if (!empty($description)): ?>
                    <div class="pxl-item--desc"><?php echo northway_html(nl2br($description)); ?></div>
                <?php endif; ?>
    ...
    ?>
        <div class="author-image-wrap">
            <label for="<?php echo esc_url($this->get_field_id('bg_box')); ?>"><?php esc_html_e('Author Image', 'northway'); ?></label>
            ...
            if ($bg_box != "") {
            ?>
                <a href="#" class="pxl-select-image pxl-btn" style="display: none;"><?php esc_html_e('Select Image', 'northway'); ?></a>
                <a href="#" class="pxl-remove-image pxl-btn"><?php esc_html_e('Remove Image', 'northway'); ?></a>
            <?php
            } else {
            ?>
                <a href="#" class="pxl-select-image pxl-btn"><?php esc_html_e('Select Image', 'northway'); ?></a>
                <a href="#" class="pxl-remove-image pxl-btn" style="display: none;"><?php esc_html_e('Remove Image', 'northway'); ?></a>
            <?php
            }
            ?>
        </div>
        ...
        <p>
            <label for="<?php echo esc_url($this->get_field_id('phone_number')); ?>"><?php esc_html_e('Phone Number', 'northway'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_url($this->get_field_id('phone_link')); ?>"><?php esc_html_e('Phone Link', 'northway'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_url($this->get_field_id('description')); ?>"><?php esc_html_e('Description', 'northway'); ?></label>
