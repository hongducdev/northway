...
$sg_featured_img_size = northway()->get_theme_opt('sg_featured_img_size', '1080x354');
$feature_image_display = northway()->get_theme_opt('feature_image_display', 'hide');
$post_breadcrumb_on = northway()->get_opt( 'post_breadcrumb_on', '1' ); 
?>
...
if ($post_tag == '1' || $post_social_share == '1'){
    ...
    <div class="post-tags-share d-flex">
        <?php
        if ($post_tag == '1'){
            ?><div class="post-tags-wrap "><?php  northway()->blog->get_post_tags(); ?></div><?php
        }
        if ($post_social_share == '1'){
            ?><div class="post-share-wrap "><?php northway()->blog->get_post_share(); ?></div><?php
        }
        ?>
    </div>
    <?php
...
<?php northway()->blog->get_post_nav(); ?>
</article>